...
function shouldEnableDirectWrapping(chainId, sourceToken, destinationToken) {
    var _a, _b;
    const wrappedTokenLowerCase = (_a = constants_1.SWAPS_WRAPPED_TOKENS_ADDRESSES[chainId]) === null || _a === void 0 ? void 0 : _a.toLowerCase();
    const nativeTokenLowerCase = (_b = constants_1.SWAPS_NATIVE_TOKEN_OBJECTS[chainId].address) === null || _b === void 0 ? void 0 : _b.toLowerCase();
    const sourceTokenLowerCase = sourceToken === null || sourceToken === void 0 ? void 0 : sourceToken.toLowerCase();
    const destinationTokenLowerCase = destinationToken === null || destinationToken === void 0 ? void 0 : destinationToken.toLowerCase();
    return ((sourceTokenLowerCase === wrappedTokenLowerCase &&
