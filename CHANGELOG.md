...
## [11.0.0]
### Uncategorized
- chore: bump `@metamask/{transaction, approval}-controller` ([#333](https://github.com/MetaMask/swaps-controller/pull/333))
- Update LICENSE ([#338](https://github.com/MetaMask/swaps-controller/pull/338))
- chore: bump `@metamask/network-controller` from `^18.1.0` to `^21.1.0` ([#332](https://github.com/MetaMask/swaps-controller/pull/332))
- chore(deps): bump @metamask/utils from 8.5.0 to 10.0.0 ([#330](https://github.com/MetaMask/swaps-controller/pull/330))
- chore: move `@metamask/gas-fee-controller` to peerDependencies ([#331](https://github.com/MetaMask/swaps-controller/pull/331))
- chore(deps-dev): bump @metamask/composable-controller ([#320](https://github.com/MetaMask/swaps-controller/pull/320))
- chore(deps): bump @metamask/controller-utils from 10.0.0 to 11.3.0 ([#322](https://github.com/MetaMask/swaps-controller/pull/322))
- chore(deps): bump @metamask/base-controller from 5.0.2 to 7.0.1 ([#319](https://github.com/MetaMask/swaps-controller/pull/319))
- chore(deps): bump @metamask/gas-fee-controller from 15.1.2 to 21.0.0 ([#328](https://github.com/MetaMask/swaps-controller/pull/328))
- chore(deps): bump @metamask/safe-event-emitter from 3.1.1 to 3.1.2 ([#329](https://github.com/MetaMask/swaps-controller/pull/329))
- chore(deps): bump secp256k1 in the npm_and_yarn group ([#327](https://github.com/MetaMask/swaps-controller/pull/327))
- chore(deps): bump @metamask/rpc-errors from 6.3.1 to 6.4.0 ([#325](https://github.com/MetaMask/swaps-controller/pull/325))
