...
## [9.0.6]
### Uncategorized
- fix: attempt to patch the dry run ([#287](https://github.com/MetaMask/swaps-controller/pull/287))
...
[Unreleased]: https://github.com/MetaMask/swaps-controller/compare/v9.0.6...HEAD
