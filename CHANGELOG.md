...
## [9.0.7]
### Uncategorized
- fix: remove setup node steps on publish ([#289](https://github.com/MetaMask/swaps-controller/pull/289))
...
[Unreleased]: https://github.com/MetaMask/swaps-controller/compare/v9.0.7...HEAD
