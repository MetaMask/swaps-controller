...
describe('getBaseApiURL', () => {
  it('should return expected values', () => {
    ...
    expect(swapsUtil.getBaseApiURL(APIType.FEATURE_FLAG, '0x1')).toBeDefined();
    expect(
...
describe('fetchAggregatorMetadata', () => {
  it('should work', async () => {
    ...
    const aggregatorsMetadata = await swapsUtil.fetchAggregatorMetadata('0x1');
...
describe('fetchSwapsFeatureLiveness', () => {
  ...
  it('should return undefined on unsupported networks', async () => {
    ...
    const featureLiveness = await swapsUtil.fetchSwapsFeatureLiveness('0x321');
