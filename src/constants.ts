...
export const SWAPS_WRAPPED_TOKENS: { [key: string]: string } = {
...
export const ALLOWED_CONTRACT_ADDRESSES: { [key: string]: string[] } = {
  [ETH_CHAIN_ID]: [
    ...
    SWAPS_WRAPPED_TOKENS[ETH_CHAIN_ID],
  ],
  [SWAPS_TESTNET_CHAIN_ID]: [
    SWAPS_CONTRACT_ADDRESSES[SWAPS_TESTNET_CHAIN_ID],
    SWAPS_WRAPPED_TOKENS[SWAPS_TESTNET_CHAIN_ID],
  ],
  [BSC_CHAIN_ID]: [
    SWAPS_CONTRACT_ADDRESSES[BSC_CHAIN_ID],
    SWAPS_WRAPPED_TOKENS[BSC_CHAIN_ID],
  ],
  [POLYGON_CHAIN_ID]: [
    SWAPS_CONTRACT_ADDRESSES[POLYGON_CHAIN_ID],
    SWAPS_WRAPPED_TOKENS[POLYGON_CHAIN_ID],
  ],
};
